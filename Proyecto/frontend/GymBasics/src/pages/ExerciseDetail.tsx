...
const ExerciseDetail: React.FC = () => {
    ...
    const calculateExerciseStats = (exercise: Exercise, workouts: any[]): any => {
        // Realiza tus cálculos y estadísticas aquí en base a los datos de los entrenamientos
        // Devuelve un objeto que contiene las estadísticas que deseas mostrar en la página
        // Por ejemplo:
        ...
        return {
            ...
            maxReps,
            maxTotalVolume,
            // Otros campos estadísticos que quieras mostrar
        };
    };

    useEffect(() => {
        // Obtén los datos de los entrenamientos relacionados con el ejercicio
    ...
    const series = [
        {
            name: 'Peso Máximo',
             data: seriesData, 
            // color: '#007bff', // La propiedad 'color' no es válida en el gráfico de línea
        },
    ];
